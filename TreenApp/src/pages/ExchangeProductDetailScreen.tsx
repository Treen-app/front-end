            ...
            <ScrollView contentContainerStyle={styles.scrollViewContainer}>
                ...
                <View style={styles.productInfo}>
                    ...
                    <View style={styles.titleContainer}>
                        <Text style={styles.exchangeProductTitle}>얼마 못 신은 신발</Text>
                        <Text style={styles.exchangeViewCount}>조회수 {mockData.views}</Text>
                    </View>
                    ...
                    <View style={styles.exchangeInfo}>
                        ...
                        />
                        <Text style={styles.overlayText}>색상교환</Text>
                        <View style={styles.colorIcon} />
                        <Image
                            source={require('../img/exchange2.png')}
                            style={styles.exchangeIconGray}
                        />
                        <View style={styles.colorIcon} />
                    </View>
                    
                    <View style={styles.exchangeSellerInfo}>
